...
<div class="theme-wrapper">
    ...
    <!-- ANALOG CLOCK (center-left overlap) -->
      ...
      <div class="clock">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <g font-family="Inter, sans-serif" font-weight="700" font-size="13" fill="#ffffff" text-anchor="middle" dominant-baseline="central">
            ...
            <text x="138" y="32" fill="#f0cd86">1</text>
            <text x="166" y="60">2</text>
            <text x="178" y="100" fill="#f0cd86">3</text>
            <text x="166" y="140">4</text>
            <text x="138" y="168" fill="#f0cd86">5</text>
            <text x="100" y="178">6</text>
            <text x="62" y="168" fill="#f0cd86">7</text>
            <text x="34" y="140">8</text>
            <text x="22" y="100" fill="#f0cd86">9</text>
            <text x="34" y="60">10</text>
...
<style>
  ...
  .sidebar{
    position:absolute; left:0; top:0; bottom:6vh; width:30vw;
    padding:2vh 1.6vw 2vh 1.4vw;
    display:flex; flex-direction:column; justify-content:space-between;
    z-index:3;
    background:linear-gradient(180deg, rgba(8,18,46,.75) 0%, rgba(8,18,46,.55) 70%, rgba(8,18,46,.1) 100%);
  }
  ...
  .clock-area{ position:absolute; right:1.4vw; top:14vh; z-index:3; }
  .clock{ width:clamp(160px,16vw,300px); aspect-ratio:1/1; background:radial-gradient(circle at 50% 50%, #0a0e1c 0%, #050913 70%, #02060f 100%); border-radius:50%; border:5px solid rgba(243,205,134,.4); box-shadow:0 30px 80px rgba(0,0,0,.6), 0 0 0 12px rgba(8,18,46,.5), inset 0 0 0 1px rgba(243,205,134,.18); position:relative; }
  ...
  .date-strip{ position:absolute; left:1.4vw; bottom:9.5vh; z-index:4; display:flex; align-items:center; gap:.8vw; color:#fff; font-size:clamp(14px,1.3vw,26px); font-weight:600; text-shadow:0 2px 10px rgba(0,0,0,.6); }
